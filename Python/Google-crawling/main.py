...
class AutoCrawler:
    def __init__(self, skip_already_exist=True, n_threads=10, do_google=True, do_naver=False, download_path='download',
                 full_resolution=False, face=False, no_gui=False, limit=70, proxy_list=None):
        """
...
if __name__ == '__main__':
    ...
    crawler = AutoCrawler(skip_already_exist=False, n_threads=32, do_google=True, do_naver=False, download_path='download',
                 full_resolution=False, face=False, no_gui=False, limit=500, proxy_list=None)
    crawler.do_crawling()
